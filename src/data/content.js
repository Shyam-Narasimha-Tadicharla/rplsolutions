...
export const services = [
  ...
  // ── Financial ─────────────────────────────────────────────────────────────────
  {
    ...
    subServices: [
      ...
      { id: 'pf-esi',               name: 'PF & ESI',                   tagline: 'Provident fund and employee state insurance compliance' },
      { id: 'pt-tds-returns',        name: 'PT & TDS Returns',           tagline: 'Professional tax and TDS return filing services' },
    ...
    capabilities: [
      ...
      { icon: Building,        title: 'Startup & Registrations', description: 'Company formations, PF/ESI registrations, MSME/DPIIT, and trade licenses.' },
      ...
      { icon: Users,           title: 'PF & ESI',               description: 'PF registration, monthly ECR filing, ESI registration, and challan payments for all business sizes.' },
      { icon: FileSearch,      title: 'PT & TDS Returns',       description: 'Professional tax registration and monthly/annual returns; TDS return filing (24Q, 26Q, 27Q) and reconciliation.' },
      { icon: Landmark,        title: 'Valuations',             description: 'Company valuation, shares & securities, intangibles, and pitch deck preparation.' },
    ],
    faq: [
      {
  ...
  },
  {
    id: 'pf-esi',
    name: 'PF & ESI',
    tagline: 'Provident fund and employee state insurance compliance made simple',
    category: 'financial',
    description:
      'We provide end-to-end PF and ESI compliance services for businesses of all sizes. From initial registration to monthly challan payments and annual returns, our team ensures your organisation meets all statutory obligations under the Employees\' Provident Funds Act and the Employees\' State Insurance Act — accurately and on time.',
    bullets: [
      'PF Registration - new establishment registration under EPFO',
      'Monthly ECR Filing - electronic challan-cum-return submission',
      'PF Withdrawal & Transfer - Form 19, 10C, 13 processing',
      'ESI Registration - employer and employee registration',
      'ESI Challan Payments - monthly contribution filing',
      'Annual Returns - PF Form 3A/6A and ESI annual returns',
      'Compliance Notices - response and representation before EPFO/ESIC',
    ],
    faq: [
      {
        question: 'Is PF registration mandatory for my business?',
        answer: 'PF registration is mandatory for establishments with 20 or more employees. Voluntary registration is available for smaller establishments. We advise on applicability and handle the end-to-end registration process.',
      },
      {
        question: 'What is the deadline for monthly PF and ESI payments?',
        answer: 'PF contributions must be deposited by the 15th of the following month, and ESI contributions by the 21st. We file the ECR and ESI challans well before these deadlines to avoid penalties.',
      },
      {
        question: 'Can you help with PF withdrawal claims for employees?',
        answer: 'Yes. We assist employees and employers with PF withdrawal (Form 19), pension withdrawal (Form 10C), and PF transfer (Form 13) submissions through the EPFO portal.',
      },
    ],
  },
  {
    id: 'pt-tds-returns',
    name: 'PT & TDS Returns',
    tagline: 'Professional tax and TDS return filing for businesses and employers',
    category: 'financial',
    description:
      'Stay fully compliant with professional tax and TDS obligations through our dedicated filing services. We handle PT registration, monthly/annual returns, TDS deduction calculations, quarterly return filing (24Q, 26Q, 27Q), TDS certificate issuance, and reconciliation with Form 26AS — keeping your business penalty-free and audit-ready.',
    bullets: [
      'PT Registration - employer and employee enrolment',
      'PT Returns - monthly and annual professional tax filings',
      'PT Challan Payments - timely deposit of PT dues',
      'TDS Return Filing - Form 24Q, 26Q, and 27Q quarterly returns',
      'TDS Certificates - Form 16, 16A generation and distribution',
      'Form 26AS Reconciliation - mismatch identification and correction',
      'TDS Notices - response drafting and representation',
    ],
    faq: [
      {
        question: 'Who is liable to deduct professional tax?',
        answer: 'Professional tax is a state-level tax. Employers are required to deduct PT from employee salaries and remit it to the state government. Applicability and slab rates vary by state. We handle PT compliance across all applicable states.',
      },
      {
        question: 'What are the quarterly TDS return due dates?',
        answer: 'TDS returns are due on July 31 (Q1), October 31 (Q2), January 31 (Q3), and May 31 (Q4). We prepare and file all quarterly returns before the due dates to avoid interest and penalties.',
      },
      {
        question: 'Can you generate and distribute Form 16 for employees?',
        answer: 'Yes. We generate Form 16 (Part A and Part B) for all employees after the financial year end and can assist with distribution or email delivery as required.',
      },
    ],
  },
  {
...
export const faq = [
  ...
  },
  {
    ...
    answer:
      "Reach out via our Contact page or email info@rpl-solutions.com. We'll schedule a discovery call, understand your requirements, and provide a detailed proposal within 2 business days.",
  },
]
...
export const jobs = [
  {
    ...
    type: 'Full-time',
    applyEmail: 'info@rpl-solutions.com',
  },
  {
